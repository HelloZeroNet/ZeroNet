...
class TestContent:
    ...
    def testInlcudeLimits(self, site, crypt_bitcoin_lib):
        ...
        # Normal data
        data_dict["signs"] = {"1TeSTvb4w2PWE81S2rEELgmX2GCCExQGT": Cryptography.sign(json.dumps(data_dict, sort_keys=True), self.privatekey)}
    ...
    def testVerify(self, site, crypt_bitcoin_lib):
        ...
        # Re-sign
        data_dict["signs"] = {
            "1TeSTvb4w2PWE81S2rEELgmX2GCCExQGT": Cryptography.sign(json.dumps(data_dict, sort_keys=True), self.privatekey)
        }
