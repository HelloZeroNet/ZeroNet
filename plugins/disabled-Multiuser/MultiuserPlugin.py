...
class UiWebsocketPlugin(object):
    ...
    def actionUserShowMasterSeed(self, to):
        ...
        message += "<b style='background: #fb9100;color:#fff;padding:3px;border-radius: 5px;'>x</b> Unlike a password, <b>a privatekey can't be reset (recovered)</b> in case you lose it!<br/><div style='margin: 16px 0; border-left: 8px solid #2980b9; background-color: #b0c9ff; border-radius: 4px; padding: 16px'><b style='color:#2980b9'>Please copy it:</b></div>"
